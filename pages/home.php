...
<body style="margin-bottom:50px ">
  ...
  <div class="input-group">
    <input id="idinputdoitac" type="text" class="form-control" NAME="doitac" placeholder="Search website liên kết ">
    <div class="input-group-btn">
     
      <button onclick="onsearch_doitac()" class="btn btn-default" type="button"  NAME="search_doitac" value="1" >
...
<script type="text/javascript">
  ...
  function onsearch_doitac(){ 
   
    str=document.getElementById("idinputdoitac").value;
